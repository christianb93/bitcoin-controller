...
import (
	...
	versioned "github.com/christianb93/bitcoin-controller/internal/generated/clientset/versioned"
	internalinterfaces "github.com/christianb93/bitcoin-controller/internal/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/christianb93/bitcoin-controller/internal/generated/listers/bitcoincontroller/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.BitcoincontrollerV1().BitcoinNetworks(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BitcoincontrollerV1().BitcoinNetworks(namespace).Watch(options)
			},
		},
